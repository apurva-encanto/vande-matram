                                ...
                                <div class="page-title-box">
                                      <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">E-Paper's List</li>
                                        </ol>
                                    </div>

                                    <h4 class="page-title">View E-Paper's List</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class=" ">
                                            <div class="row mt-2 border-bottom border-light">
                                                <div class="d-flex align-items-start mb-2 ">
                                                    ...
                                                    <a href="{{route('admin.epaper.add')}}" class="btn btn-primary">Add</a>
                                                </div>
                                        ...
                                        <div class="table-responsive">
                                            <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                                <thead>
                                                <tr>
                                                    <th data-toggle="true" style="background: #eee;">Date</th>
                                                    <th style="background: #eee;">City</th>
                                                ...
                                                <tr>
                                                    <td>{{$list->date}}</td>
                                                    <td class="text-uppercase">{{$list->place}}</td>
                                                    <td>  @if($list->status==1)
                                                        ...
                                                        @endif</td>
                                                    <td>
                                                        <a href="{{ route('admin.epaper.edit',$list->id) }}" class="btn btn-xs btn-info mb-1"><i class="mdi mdi-pencil"></i></a>
                                                       <a  data-bs-toggle="modal" data-bs-target="#danger-alert-modal{{$list->id}}" class="btn btn-xs btn-danger mb-1"><i class="mdi mdi-delete"></i></a>
                                                    </td>

                                                </tr>

                                                <div id="danger-alert-modal{{$list->id}}" class="modal fade" tabindex="-1" style="display: none;" aria-hidden="true">
                                                    <div class="modal-dialog modal-sm">
                                                        <div class="modal-content modal-filled bg-danger">
                                                            <div class="modal-body p-4">
                                                                <div class="text-center">
                                                                <form action="{{ route('admin.epaper.delete',$list->id) }}" method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <i class="dripicons-wrong h1 text-white"></i>
                                                                    <h4 class="mt-2 text-white">Delete E-Paper</h4>
                                                                    <p class="mt-3 text-white">Are you sure you want to delete E-Paper .</p>
