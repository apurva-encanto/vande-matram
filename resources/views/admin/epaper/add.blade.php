                                ...
                                <div class="page-title-box">
                                      <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Add E-paper</li>
                                        </ol>
                                    </div>

                                    <h4 class="page-title">Add New E-Paper</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                                            ...
                                            <div class="col-xl-6">
                                                <form id="addArticle"  method="post" enctype="multipart/form-data"  action="{{ route('admin.epaper.create')}}" >
                                                    ...
                                                    <div class="mb-3 ">
                                                        ...
                                                        <input type="date"  value="{{date('Y-m-d')}}"  name="epaper_date" class="form-control " required placeholder="E-Paper Date" required>
                                                            @error('epaper_date')
                                               ...
                                               <div class="col-xl-12">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="radio" name="is_download" value="1" id=""> Yes
                                                        <input type="radio" name="is_download" value="0" checked id=""> No
