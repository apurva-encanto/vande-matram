                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row mt-3 p-3">
                                            <div class="col-xl-6">
                                                <form id="addArticle"  method="post" enctype="multipart/form-data"  action="{{ route('admin.article.update',$article->id) }}" >
                                                    @csrf
                                                    <div class="mb-3">
                                                   ...
                                                   <div class="mb-3">
                                                        ...
                                                        <div class="form-group">
                                                            <input  value="{{$article->city}}" pattern="[A-Za-z ]+"  type="text" placeholder="Enter City" id=""  name="city" class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="mb-3">
