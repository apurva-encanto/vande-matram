                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-xl-6">
                                                <form id="myForm" class="needs-validation" method="post" enctype="multipart/form-data" novalidate action="{{ route('agent.account.edit')}}" >
                                                    @csrf
                                                    <div class="mb-3">
                                                        <label for="Name" class="form-label">Name</label>
                                                        <input type="text" pattern="[A-Za-z ]+" value="{{auth()->user()->name}}" required  name="name" class="form-control" placeholder="Agent Name" >
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="Email" class="form-label">Email Address</label>
                                                        <input type="email" value="{{auth()->user()->email}}" required  name="email" class="form-control" placeholder="Agent Email Address" >
                                                            @error('email')
                                                   ...
                                                   <div class="mb-3">
                                                        ...
                                                        <input type="password" value="{{old('password')}}"   name="password" class="form-control" placeholder="Agent Password" >
                                                    </div>
                                            ...
                                            <div class="col-xl-6">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" value="{{auth()->user()->phone}}" required  name="phone" class="form-control" placeholder="Agent Phone Number" >
                                                           @error('phone')
                                                                <div class="text-danger">{{ $message }}</div>
                                                            @enderror
                                                    </div>
                                                    <div class="my-3 mt-xl-0">
                                                <label for="projectname" class="mb-0 form-label">Agent Image</label>
