                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-xl-6">
                                                <form id="addArticle"  method="post" enctype="multipart/form-data"  action="{{ route('agent.account.edit')}}" >
                                                    @csrf
                                                    <div class="mb-3">
                                                        <label for="Name" class="form-label">Name</label>
                                                        <input type="text" value="{{auth()->user()->name}}" required  name="name" class="form-control" placeholder="Agent Name" >
                                                    </div>
                                                    <div class="mb-3">
